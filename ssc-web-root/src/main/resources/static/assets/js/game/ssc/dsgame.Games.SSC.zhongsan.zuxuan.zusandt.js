...
(function(host, GameMethod, undefined){
	...
	var pros = {
        ...
        for(i=0;i < tuolen;i++){
				...
				for(var c=0;c<tuoarr.length;c++){
          checkNum =[];
					saveNum = tuoarr[c];
          if (saveNum!=arr[0]) {
            checkNum.push([[arr[0],arr[0]].join('')]);
					  checkNum.push(saveNum);
            //console.log(me.permutations(checkNum,2));
					  result = result.concat(me.permutations(checkNum,2));
          }else {
