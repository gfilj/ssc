    ...
    var r = {
      ...
      , o = {
        ...
        miniTrend_createRowHtml: function() {
            var e, t = this, a = t.miniTrend_getBallsData(), n = a.length, r = "", i = "curr", o = [];console.log(a);
        ...
        miniTrend_updateTrend: function(e) {
            ...
            if($('#f1AnimateIframe').length > 0){
            	t.miniTrend_getContainer().find('tr.first').hide();
            	setTimeout(function(){
                	t.miniTrend_getContainer().find('tr.first').show();
            	},14000);
            }
    ...
    var r, i = {
        ...
        setRebate: function(t, a) {
            ...
            // t[1]) {
                ...
                // n = e.share.util.formatMoney(t[0], 0) + "." + i
            // } else
                // n = e.share.util.formatMoney(t[0], 2);
